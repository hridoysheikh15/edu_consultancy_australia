    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('about_us.section_one.update') }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="summernote" id="description" name="section_one_description">{{ $pageLayout?->description_one }}</textarea>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('about_us.section_two.update') }}" method="post"
                    enctype="multipart/form-data">@csrf
                    <div class="form-group">
                        <label for="header">Header</label>
