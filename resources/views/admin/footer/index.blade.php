...
@section('content')
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Footer Settings</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="pb-3">
                    <h4 class="fw-bold"><strong>Top section</strong></h4>
                </div>

                <form action="{{ route('footer_setting.page_layout.update') }}" method="post">@csrf
                    <div class="form-group">
                        <label for="header">Header</label>
                        <input type="text" name="header" id="header" value="{{ $pageLayout?->header }}"
                            class="form-control @error('header') is-invalid @enderror">
                    </div>
                    <div class="form-group">
                        <label for="description">Description</label><br>
                        <textarea class="summernote" id="description" name="description">{{ $pageLayout?->description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="branch_header">Branch Header</label>
                        <input type="text" name="branch_header" id="header" value="{{ $pageLayout?->branch_title }}"
                            class="form-control @error('branch_header') is-invalid @enderror">
                    </div>
                        ...
                        <div class="default-tab">
                            ...
                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                    ...
                                                    @forelse ($cards as $card)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                style="gap: 10px" >
                                                                    <a href="{{ route('footer_setting.card.edit', $card?->id) }}"
                                                                        class="btn btn-outline-primary btn-sm">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <form action="{{ route('footer_setting.card.delete', $card?->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
                                ...
                                <div class="tab-pane fade " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    ...
                                    <div class="mt-4">
                                        <form action="{{ route('footer_setting.card.store') }}" method="post"enctype="multipart/form-data"
