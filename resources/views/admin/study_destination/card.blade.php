...
@section('title', '| Destination Card')
@push('css')
...
@section('content')
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Destination Card</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('study_destination.card.section.heading') }}" method="post"
                    class="form-horizontal">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="header">Section Heading</label>
                        <input type="text" id="header" name="card_section_header"
                            value="{{$sectionHeading?->section_four_header }}"
                        ...
                        <div class="default-tab">
                                ...
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link nav-padding" id="nav-home-tab" data-toggle="tab"
                                        href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><span
                                            class="ti-plus"></span> Create Card</a>
                                </div>
                            </nav>
                            ...
                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                ...
                                                @forelse ($cards as $card)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            style="gap: 10px" >
                                                                <a href="{{ route('study_destination.card.edit', $card?->id) }}"
                                                                    class="btn btn-outline-primary btn-sm">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <form action="{{ route('study_destination.card.delete', $card?->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                ...
                                <div class="tab-pane fade " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    ...
                                    <div class="mt-4">
                                        <form action="{{ route('study_destination.card.store') }}" method="post"
                                           class="form-horizontal">
                                            @csrf
                                            <div class="form-group mb-3">
